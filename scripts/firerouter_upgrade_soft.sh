...
# call post upgrade
${FIREROUTER_HOME}/scripts/fireupgrade_post.sh

# call upgrade
${FIREROUTER_HOME}/scripts/firelog -t cloud -m  "INFO: Upgrade completed with services restart in soft mode $commit_before $commit_after"
